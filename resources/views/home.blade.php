            ...
            <div class="col-112 hero-text-image">
                <div class="row">
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Reoil membantu anda untuk mengolah
                            minyak jelantah.</p>
                        <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="#"
                                class="btn btn-outline-white">Mulai</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-center">
                    <iframe width="500" height="215" src="https://www.youtube.com/embed/F-v7UbnpXf8?controls=0"
